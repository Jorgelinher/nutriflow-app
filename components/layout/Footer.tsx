        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/perfil" className="text-gray-300 hover:text-nutri-secondary transition-colors duration-200">
                  Sobre Mí
                </Link>
              </li>
              <li>
                <Link href="/servicios" className="text-gray-300 hover:text-nutri-secondary transition-colors duration-200">
                  Servicios
                </Link>
              </li>
            </ul>

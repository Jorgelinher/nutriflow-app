    ...
    <footer className="bg-nutri-primary text-white py-12">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            ...
            <ul className="space-y-2 text-nutri-light">
              ...
              <li><Link href="/perfil" className="hover:text-white transition-colors">Sobre Mí</Link></li>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="border-t border-nutri-secondary mt-8 pt-8 text-center text-nutri-light"
        >
